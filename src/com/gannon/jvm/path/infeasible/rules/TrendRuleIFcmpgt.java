...
public class TrendRuleIFcmpgt extends TrendRule {
	private boolean expectedPredicateResult;
	
	public TrendRuleIFcmpgt(boolean expectedPredicateResult, Dependencies dependecies, BinNode leftNode, BinNode rightNode, Map<BinNode, InfeasibleDetectData> detectDataCollectMap) {
