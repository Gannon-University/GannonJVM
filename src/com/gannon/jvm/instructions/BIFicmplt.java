...
public class BIFicmplt extends BPredicateInstruction {
	public BIFicmplt(BLabel Label, int lineNumber) {
	...
	public Object execute(PathFrame pathFrame) {
		...
		if (firstValue.desc.equals("I") && secondValue.desc.equals("I")) {
			...
			System.err.println("BIFicmple excution method inputs are not integer type. ");
		}
