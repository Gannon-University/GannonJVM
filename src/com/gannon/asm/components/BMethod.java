...
public class BMethod {
	...
	private BLocalVarTable localVariables = new BLocalVarTable();
	...
	public void addInput(Input input){
		for(BLocalVariable var: input.getParas()){
			localVariables.setValueAtIndex(var.index, var.getValue());
		}
	}
	...
	public BLocalVarTable getLocalVariables() {
