...
public class SudokuBoard {
    ...
    protected  int size  = 0;           // Size of the board (number of rows and columns)
    protected int box_size;       // Size of the inner boxes

    protected int[][] board;    // 2D array representing the game board
     ...
     */
    public void setBaseCell(int num, int row, int col) {
        board[row][col] = num;
    }
