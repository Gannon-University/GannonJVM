...
public class TrendRuleIFcmpleTest {
	@Rule
	...
	public void testCmpleTrue() {
		...
		Dependency d4 = new Dependency(i4, new BIFicmple( lable,2));
		...
		TrendRuleIFcmple rule = new TrendRuleIFcmple(expectedPredicate, dependencies, i2, i3,detectDataCollectMap);
		rule.updating();
