...
public class TrendRuleIFcmpltTest {
	...
	public void testCmpltTrue() {
		...
		Dependency d4 = new Dependency(i4, new BIFicmplt( lable,2));
		...
		TrendRuleIFcmplt rule = new TrendRuleIFcmplt(expectedPredicate, dependencies, i2, i3,detectDataCollectMap);
		rule.updating();
