...
public class BIConst_3Test {
	...
	public void testExecute() {
		...
		// Before calling the execute method, LocalVariableTable and operand
		// stack will be empty
		...
		assertEquals(3, resultOprndStack.peek().getValue());
	}
	...
	public void testDependencyIConst_3() {
		...
		// dependency.getIntermediateVariableNameStack();
