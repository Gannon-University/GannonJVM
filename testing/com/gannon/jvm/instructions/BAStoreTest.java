...
public class BAStoreTest {
	...
	public void testExecuteBFramePostion0() {
		...
		Object result = resultVarTable.getLocalVariableByIndex(0); //get the value from 0th position of resulted Local variable table
	...
	public void testExecuteBFramePostion2() {
		...
		Object result = resultVarTable.getLocalVariableByIndex(2);//get the value from 2nd position of resulted Local variable table
